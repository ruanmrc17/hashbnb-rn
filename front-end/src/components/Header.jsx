...
return (
    ...
    <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-8 ">
        ...
        <div className="border-r border-r-gray-300 pr-4">Qualquer lugar</div>
        <div className="border-r border-r-gray-300 px-4">Qualquer semana</div>
        <div className="px-4">Hóspedes?</div>
        ...
        <Link to={user ? '/account' : '/login'} className="flex items-center gap-2 rounded-full border border-gray-300 py-2 pr-4 pl-6 shadow-md">
        <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            fill="currentColor"
